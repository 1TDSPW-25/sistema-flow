        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6 px-10 py-12">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              disabled={enviando}
              className="w-full rounded-xl border border-green-400 bg-green-50/40 px-4 py-3 text-base text-green-900 placeholder:text-green-900/50 outline-none transition focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-300 disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-green-400 bg-white p-3 text-gray-800 
               placeholder-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-400 
               focus:ring-offset-0 focus:outline-none transition duration-200 ease-in-out"
            />
          </div>

          <div className="rounded-xl border bg-gray p-4 text-sm bg-gray">
          ...
          <button
            ...
            className="mt-2 inline-flex items-center justify-center rounded-xl 
             bg-green-400 px-8 py-3 text-sm font-semibold uppercase tracking-widest 
             text-white transition hover:bg-green-500 focus-visible:outline-2 
